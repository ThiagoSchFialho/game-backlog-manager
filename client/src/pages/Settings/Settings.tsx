                ...
                <div className="settings-main-content">
                    <div className="page-header">
                        ...
                        <div className="steam-section">
                            ...
                            <form className="steam-section-form">
                                <div className="input-label-container">
                                    <label htmlFor="steam-id">ID da sua conta Steam</label>
                                    <div className="input-container">
                                        <input type="text" name="steam-id" id="steam-id" maxLength={17} minLength={17} />
                                ...
                                <div className="input-label-container">
                                    ...
                                    <div className="input-container"> 
                                        <input type="text" name="steam-key" id="steam-key" maxLength={33} minLength={33} />
                                        <img src={info} alt="informação" />
                                    </div>
                                </div>
